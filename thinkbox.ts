/*
 * Functions to ThinkBot by QWERTY EDU Co.,Ltd.
 *
*/
...
{
    /**
    * Select the servo on the S1 or S2 or S3 or S4
    */
    ...
    */
    ...
    export function Servo(channel: ServoList, degree: number): void {
        if (!initialized) {
            initPCA9685();
        }
        // 50hz: 20,000 us
    ...
    */
    ...
    export function ServoPulse(channel: ServoList, pulse: number): void {
        if (!initialized) {
            initPCA9685();
        }
        // 50hz: 20,000 us
